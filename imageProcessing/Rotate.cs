...
namespace imageProcessing
{
    public class Rotate
    {
        public static Bitmap RotateImage(Bitmap originalImage, float angle)
        {
            ...
            Graphics g = Graphics.FromImage(rotatedImage); //Resim üzeride çizim yapmamızı sağlar.
                
            //Transformasyonlar, resmi doğru bir şekilde döndürmek ve merkezlemek için kullanılır:
