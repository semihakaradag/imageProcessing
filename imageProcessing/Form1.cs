    ...
    public partial class Form1 : Form
    {
        ...
        private void cropButton_Click(object sender, EventArgs e)
        {
            if (originalImage != null)
            {
                ...
                int right = int.Parse(leftTextBox.Text);
                int top = int.Parse(topTextBox.Text);
                int width = int.Parse(widthTextBox.Text);
                int height = int.Parse(heightTextBox.Text);

                // Resmi kırp
                Bitmap croppedImage = Crop.CropImage(originalImage, right, top, width, height);
                pictureBox.Image = originalImage; // Orijinal resmi ilk PictureBox'a yükle
        ...
        private void zoomOutButton_Click(object sender, EventArgs e)
        {
            if (originalImage != null)
            {
                double zoomFactor = 0.50; // Uzaklaştırma faktörü, istediğiniz değeri kullanabilirsiniz
                ...
                pictureBox1.ClientSize = new Size(originalImage.Width / 8, originalImage.Height / 8);
        ...
        private void zoomInButton_Click(object sender, EventArgs e)
        {
            if (originalImage != null)
            {
                double zoomFactor = 8; // Yakınlaştırma faktörü, istediğiniz değeri kullanabilirsiniz
                ...
                // Zoom işlemi yapıldığı için pictureBox1'in resmi görüntüleme alanını ayarlayın
                pictureBox1.ClientSize = new Size(originalImage.Width * 1, originalImage.Height * 1);
